            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/profile">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">Jabatan</label>

                            <div class="col-md-6">
                                <input id="jabatan" value="{{ $user->jabatan}}" type="text" class="form-control @error('jabatan') is-invalid @enderror" name="jabatan" value="{{ old('jabatan') }}" required>
